                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            <li class="nav-item active"><a class="nav-link" href="\new-sapphire/rooms.php">Back</a></li> 
                            <li class="nav-item active"><a class="nav-link" href="\new-sapphire/index.html">Home</a></li> 
       ...
       <div class="row">
        ...
        <div class="row">
			...
			<div class="form-group">
		    	...
		    	<input type="text" class="form-control" name="room_type" value="<?php if($_GET['rt'] == 'a'){echo 'Single Deluxe';}if($_GET['rt'] == 'b'){echo 'Double Deluxe';}if($_GET['rt'] == 'c'){echo 'Semi Luxury';}if($_GET['rt'] == 'd'){echo 'Super Luxury';}?>" readonly>
		  	</div>
            <div class="form-group">
